...
function App() {
  const [heading1, setHeading1] = useState('not working');
  useEffect(() => {
  ...
  const [heading2, setHeading2] = useState('not working');
  useEffect(() => {
  ...
  const [heading3, setHeading3] = useState('not working');
  useEffect(() => {
  ...
  const [f1c1, setf1c1] = useState('not working');
  useEffect(() => {
  ...
  const [f1c2, setf1c2] = useState('not working');
  useEffect(() => {
  ...
  const [f1c3, setf1c3] = useState('not working');
  useEffect(() => {
  ...
  const [f2c1, setf2c1] = useState('not working');
  useEffect(() => {
  	fetch('/f2c1').then(res => res.json()).then(data2 => {
  	  setf2c1(data2.f2c1);
  	});
  }, []);
  const [f2c2, setf2c2] = useState('not working');
  useEffect(() => {
  	fetch('/f2c2').then(res => res.json()).then(data2 => {
  	  setf2c2(data2.f2c2);
  	});
  }, []);
  const [f2c3, setf2c3] = useState('not working');
  useEffect(() => {
  ...
  const [f3c1, setf3c1] = useState('not working');
  useEffect(() => {
  ...
  const [f3c2, setf3c2] = useState('not working');
  useEffect(() => {
  ...
  const [f3c3, setf3c3] = useState('not working');
  useEffect(() => {
  	fetch('/f3c3').then(res => res.json()).then(data2 => {
  	  setf3c3(data2.f3c3);
  	});
  }, []);
  const [f4c1, setf4c1] = useState('not working');
  useEffect(() => {
  ...
  const [f4c2, setf4c2] = useState('not working');
  useEffect(() => {
  ...
  const [f4c3, setf4c3] = useState('not working');
  useEffect(() => {
  ...
  const [f5c1, setf5c1] = useState('not working');
  useEffect(() => {
  ...
  const [f5c2, setf5c2] = useState('not working');
  useEffect(() => {
  ...
  const [f5c3, setf5c3] = useState('not working');
  useEffect(() => {
